...
mixin _$DownloadsState {
  ...
  List<DownloadsModel>? get downloadsList => throw _privateConstructorUsedError;
  Option<Either<MainFailures, List<DownloadsModel>>>
      get downloadsSuccessOrFailureOtion => throw _privateConstructorUsedError;
...
abstract class $DownloadsStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Option<Either<MainFailures, List<DownloadsModel>>>
          downloadsSuccessOrFailureOtion});
}
...
class _$DownloadsStateCopyWithImpl<$Res, $Val extends DownloadsState>
  ...
  $Res call({
    ...
    Object? downloadsList = freezed,
    Object? downloadsSuccessOrFailureOtion = null,
  }) {
    return _then(_value.copyWith(
      isLoading: null == isLoading
          ...
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
      downloadsList: freezed == downloadsList
          ? _value.downloadsList
          : downloadsList // ignore: cast_nullable_to_non_nullable
              as List<DownloadsModel>?,
      downloadsSuccessOrFailureOtion: null == downloadsSuccessOrFailureOtion
          ? _value.downloadsSuccessOrFailureOtion
          : downloadsSuccessOrFailureOtion // ignore: cast_nullable_to_non_nullable
...
class _$_DownloadsState implements _DownloadsState {
  const _$_DownloadsState(
      ...
      required this.downloadsSuccessOrFailureOtion})
      : _downloadsList = downloadsList;

  @override
  final bool isLoading;
  final List<DownloadsModel>? _downloadsList;
  @override
  List<DownloadsModel>? get downloadsList {
    final value = _downloadsList;
  ...
  @override
  String toString() {
    return 'DownloadsState(isLoading: $isLoading, downloadsList: $downloadsList, downloadsSuccessOrFailureOtion: $downloadsSuccessOrFailureOtion)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.downloadsSuccessOrFailureOtion,
                    downloadsSuccessOrFailureOtion) ||
                other.downloadsSuccessOrFailureOtion ==
                    downloadsSuccessOrFailureOtion));
  }
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      required final Option<Either<MainFailures, List<DownloadsModel>>>
          downloadsSuccessOrFailureOtion}) = _$_DownloadsState;
  ...
  @override
  Option<Either<MainFailures, List<DownloadsModel>>>
      get downloadsSuccessOrFailureOtion;
  @override
  @JsonKey(ignore: true)
  _$$_DownloadsStateCopyWith<_$_DownloadsState> get copyWith =>
      throw _privateConstructorUsedError;
